...
import com.kostyarazboynik.todoapp.data.repository.utils.Mappers.modelToNetworkEntity
import com.kostyarazboynik.todoapp.data.repository.utils.Mappers.networkEntityToModel
...
class RemoteToDoItemRepositoryImpl @Inject constructor(
    private val sharedPreferences: SharedPreferencesAppSettings,
    private val service: ToDoItemApi,
): RemoteToDoItemRepository {

    override suspend fun getMergedToDoItems(currentList: List<ToDoItem>): Flow<DataState<List<ToDoItem>>> =
        flow {
            try {
    ...
    override suspend fun updateRemoteToDoItem(toDoItem: ToDoItem) {
        try {
    ...
    override suspend fun deleteRemoteToDoItem(id: String) {
        try {
    ...
    override suspend fun createRemoteToDoItem(newToDoItem: ToDoItem) {
        try {
